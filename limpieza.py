...
##PARA CONVERTIR LOS NUMEROS A INT
...
#%%
## PARA FILTRAR LOS ELEMENTOS QUE NO SON PORTATILES
...
## PARA MAPEAR LAS CIUDADES NUMERICAMENTE
...
#%%
df.to_csv('datos_limpios_1.csv', index=False)